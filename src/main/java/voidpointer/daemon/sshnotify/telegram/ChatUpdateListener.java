...
final class ChatUpdateListener {
    ...
    public ChatUpdateListener(final UserRepository userRepository, final SshNotifyVoidBot bot, final BanConfig banConfig) {
        callbackHandlerManager = new CallbackHandlerManager(userRepository, bot, banConfig);
    }
